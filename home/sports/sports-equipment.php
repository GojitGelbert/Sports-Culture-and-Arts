...
<body>
  <div class="bodycontainer">
    <div class="maincontainer">
        ...
        <nav id="nav-group">
          ...
          <ul class="nav-ul">
            <li class="nav-li">
              ...
              <img class="selected-2"
                src="https://github.com/gracelajohnmark/Sports_Culture_Arts/blob/02eaa2f37fcded1cb8eb526ea8999286c5c867ca/img/selected%201.png?raw=true" />
            </li>
            <li>
          ...
          <div class="vector-wrapper">
            <img class="search-icon"
              src="https://github.com/gracelajohnmark/Sports_Culture_Arts/blob/ec6e3c09be58d3e17a5e649e2f78f4f2079dda41/img/search-icon.png?raw=true" />
          </div>
          ...
          <ul class="sidenav-ul">
            <li class="sidenav-li-menu">
              <a href="" class="navigation-menu">
                <img class="navmenu"
                  src="https://github.com/gracelajohnmark/Sports_Culture_Arts/blob/445c8a15a86abbc49aeffc2bb7655b2d593f07fa/img/Navigation%20M.png?raw=true" />
            ...
            <li class="sidenav-li">
              <button class="dropdown-btn">
                <img class="skcforms"
                  src="https://github.com/gracelajohnmark/Sports_Culture_Arts/blob/445c8a15a86abbc49aeffc2bb7655b2d593f07fa/img/form.png?raw=true"
                  alt="all types of skc forms" />
                <span>SKC forms</span>
                <img
              ...
              <ul class="sub-menus">
                ...
                <li><a href="#">Varsity Application Form</a></li>
                <li><a href="#">Athlete Registration Form</a></li>
                <li><a href="#">Application for Sports Club</a></li>
              </ul>
            </li>
          </ul>
        </aside>
      ...
      <div class="container">
        <p class="intro">Welcome to Sports Culture and Arts SorSU Bulan Campuses</p>
        ...
        <div class="component">
          <iframe class="image"
            ...
            allowfullscreen="true" autoplay="true" ; clipboard-write; encrypted-media; picture-in-picture; web-share
            allowFullScreen="true"></iframe>
          <div class="text-wrapper-3">Basketball</div>
        </div>
      </div>
      <img class="vector-8" src="https://c.animaapp.com/w7WS4Fj2/img/vector-9.svg" />
